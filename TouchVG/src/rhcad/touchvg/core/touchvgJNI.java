...
public class touchvgJNI {
  ...
  public static void SwigDirector_GiView_getLocalizedString(GiView jself, String name, long result) {
    jself.getLocalizedString(name, (result == 0) ? null : new MgStringCallback(result, false));
  }
